...
public partial class ModuleWeaver
{
    public void Init()
    {
        var logManagerType = FindTypeDefinition("log4net.LogManager");
        ...
        var loggerTypeDefinition = FindTypeDefinition("log4net.ILog");

        var assembly = FindTypeDefinition("System.Reflection.Assembly");
        ...
        DebugExceptionMethod =
            ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Debug", "Object", "Exception"));
        ...
        InfoExceptionMethod =
            ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Info", "Object", "Exception"));
        ...
        WarnExceptionMethod =
            ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Warn", "Object", "Exception"));
        ...
        ErrorExceptionMethod =
            ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Error", "Object", "Exception"));
