...
public class MetroLogTests
{
    ...
    public MetroLogTests()
    {
        ...
        assembly = moduleWeaver.ExecuteTestRun("MetroLogAssemblyToProcess.dll").Assembly;
...
// ReSharper restore RedundantJumpStatement
    ...
    public void Info()
    {
        ...
        Assert.StartsWith("Method: 'Void Info()'. Line: ~", Information.First());
    }
    ...
    public void InfoString()
    {
        ...
        instance.InfoString();
        Assert.Single(Information);
        Assert.StartsWith("Method: 'Void InfoString()'. Line: ~", Information.First());
    }
    ...
    public void InfoStringFunc()
    {
        ...
        Assert.Single(Information);
        Assert.StartsWith("Method: 'Void InfoStringFunc()'. Line: ~", Information.First());
    }
    ...
    public void InfoStringParams()
    {
        ...
        Assert.Single(Information);
        Assert.StartsWith("Method: 'Void InfoStringParams()'. Line: ~", Information.First());
    }
    ...
    public void InfoStringException()
    {
        ...
        Assert.Single(Information);
        Assert.StartsWith("Method: 'Void InfoStringException()'. Line: ~", Information.First());
    }
    ...
    public void InfoStringExceptionFunc()
    {
        ...
        Assert.Single(Information);
        Assert.StartsWith("Method: 'Void InfoStringExceptionFunc()'. Line: ~", Information.First());
    }
