...
public partial class ModuleWeaver
{
    public void Init()
    {
        ...
        WriteMethod = ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("WriteWithData", "String", "Object", "LogEvent"));
        WriteExceptionMethod = ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("WriteWithData", "Exception", "String", "Object", "LogEvent"));
