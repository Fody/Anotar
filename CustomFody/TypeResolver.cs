...
public partial class ModuleWeaver
{
    public void Init()
    {
        ...
        TraceFormatMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Trace", "String", "Object[]")));
        TraceMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Trace", "String")));
        ...
        DebugFormatMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Debug", "String", "Object[]")));
        DebugMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Debug", "String")));
        ...
        InformationFormatMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Information", "String", "Object[]")));
        InformationMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Information", "String")));
        ...
        WarningFormatMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Warning", "String", "Object[]")));
        WarningMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Warning", "String")));
        ...
        ErrorFormatMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Error", "String", "Object[]")));
        ErrorMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Error", "String")));
        ...
        FatalFormatMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Fatal", "String", "Object[]")));
        FatalMethod = new Lazy<MethodReference>(() => ModuleDefinition.ImportReference(loggerTypeDefinition.FindMethod("Fatal", "String")));
