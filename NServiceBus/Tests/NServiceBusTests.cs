...
public class NServiceBusTests
{
    ...
    public async Task OnExceptionToInfo()
    {
        ...
        await CheckException(action, Infos, expected);
    }
    ...
    public async Task Info()
    {
        ...
        var instance = (dynamic) Activator.CreateInstance(type);
        instance.Info();
        await Assert.That(Infos).HasSingleItem();
        await Assert.That(Infos.First()).StartsWith("Method: 'Void Info()'. Line: ~");
    }
    ...
    public async Task InfoString()
    {
        ...
        instance.InfoString();
        await Assert.That(Infos).HasSingleItem();
        await Assert.That(Infos.First()).StartsWith("Method: 'Void InfoString()'. Line: ~");
    }
    ...
    public async Task InfoStringFunc()
    {
        ...
        await Assert.That(Infos).HasSingleItem();
        await Assert.That(Infos.First()).StartsWith("Method: 'Void InfoStringFunc()'. Line: ~");
    }
    ...
    public async Task InfoStringParams()
    {
        ...
        await Assert.That(Infos).HasSingleItem();
        await Assert.That(Infos.First()).StartsWith("Method: 'Void InfoStringParams()'. Line: ~");
    }
    ...
    public async Task InfoStringException()
    {
        ...
        await Assert.That(Infos).HasSingleItem();
        await Assert.That(Infos.First()).StartsWith("Method: 'Void InfoStringException()'. Line: ~");
    }
    ...
    public async Task InfoStringExceptionFunc()
    {
        ...
        await Assert.That(Infos).HasSingleItem();
        await Assert.That(Infos.First()).StartsWith("Method: 'Void InfoStringExceptionFunc()'. Line: ~");
    }
