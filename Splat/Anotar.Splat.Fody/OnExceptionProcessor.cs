...
class OnExceptionProcessor
{
    ...
    IEnumerable<Instruction> GetCatchInstructions()
    {
        ...
        {
            foreach (var instruction in AddWrite(ModuleWeaver.DebugExceptionMethod, OpCodes.Ldc_I4_1))
            {
                yield return instruction;
            }
        }
        ...
        {
            foreach (var instruction in AddWrite(ModuleWeaver.InfoExceptionMethod, OpCodes.Ldc_I4_2))
            {
                yield return instruction;
            }
        }
        ...
        {
            foreach (var instruction in AddWrite(ModuleWeaver.WarnExceptionMethod, OpCodes.Ldc_I4_3))
            {
                yield return instruction;
            }
        }
        ...
        {
            foreach (var instruction in AddWrite(ModuleWeaver.ErrorExceptionMethod, OpCodes.Ldc_I4_4))
            {
                yield return instruction;
            }
        }
        ...
        {
            foreach (var instruction in AddWrite(ModuleWeaver.FatalExceptionMethod, OpCodes.Ldc_I4_5))
            {
                yield return instruction;
            }
        }
    ...
    IEnumerable<Instruction> AddWrite(MethodReference writeMethod, OpCode enumValue)
    {
