...
class OnExceptionProcessor
{
    ...
    IEnumerable<Instruction> GetCatchInstructions()
    {
        ...
        {
            foreach (var instruction in AddWrite(ModuleWeaver.InformationExceptionMethod,
                ModuleWeaver.IsInformationEnabledMethod))
            {
                yield return instruction;
            }
        }
        ...
        {
            foreach (var instruction in AddWrite(ModuleWeaver.WarningExceptionMethod,
                ModuleWeaver.IsWarningEnabledMethod))
            {
                yield return instruction;
            }
        }
